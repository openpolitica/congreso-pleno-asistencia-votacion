...
public record AsistenciaSesion(
  ...
  public String printResultadosPorGrupoAsCsv() {
    ...
    // JP,5,4,0,1,0
    // NA,4,2,2,0,0
    return ("grupo_parlamentario,numero_legal,presentes,ausentes,licencias,suspendidos,otros\n"
  ...
  public static class Builder {
    ...
    public Builder withAsistencias(
        Map<String, String> grupos, List<ResultadoCongresista<Asistencia>> asistencias) {
      ...
      for (var asistencia : asistencias) {
        var grupoParlamentario =
            new GrupoParlamentario(
                asistencia.grupoParlamentario(), grupos.get(asistencia.grupoParlamentario()));
    ...
    private void checkResultsMatch(
      ...
      if (presentes != resultados.presentes()
