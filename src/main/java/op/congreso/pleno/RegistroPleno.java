...
public record RegistroPleno(
    ...
    public String printPlenoAsCsv() {
        return "metadato,valor" + "\n" +
                "periodo_parlamentario," + periodoParlamentario + "\n" +
                "periodo_anual," + periodoAnual + "\n" +
                "legislatura," + legislatura + "\n" +
                "sesion," + titulo + "\n" +
                "url_pdf," + url + "\n" +
                "dia," + fecha.format(DateTimeFormatter.ISO_LOCAL_DATE) + "\n";
    }
    ...
    public static class Builder {
        ...
        public void withGruposParlamentarios(Map<String, String> gruposParlamentarios) {
